...
const NOTE_INSTRUCTIONS = 'Wil je dat wij er iets voor je opzetten? Laat dan hier je bericht achter.'
...
const Cardnote = () => {
  ...
  return (
    <>
      ...
      <ConfirmMessage success={success}><FiCheck /> <span className="landingpage-p">{CONFIRM_MESSAGE}</span></ConfirmMessage>
    </>
  )
}
